...
<body>
	<nav class="navbar navbar-expand-lg bg-dark custom-bg">
		<div class="container">
			<a class="navbar-brand" href="home">Amit's Spring Project</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link"
						href="login">Home <span class="sr-only"></span></a></li>
					<li class="nav-item active"><a class="nav-link"
						href="register">SignUp <span class="sr-only"></span></a></li>
