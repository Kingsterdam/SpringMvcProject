...
<body>
	...
	<div>
		<nav class="navbar navbar-expand-sm bg-light navbar-light">
			<span class="title mb-0 h1" style="padding-left: 1%;">Amit's
				Library</span><span class="user mb-0 h5"
	...
	<div class='table'>
		<table
			class="table table-sm table-hover table-bordered table-striped align-middle table-dark"
			border="1">
