		...
		<div class="row py-5 mt-5">
			<div class="row">
				<div style="margin-left: 450px">
					<h4>
						<font color="#C0C0C0">Edit Books Details</font>
					</h4>
				</div>
				<div class="col-md-6 offset-md-3">
					<div class="addBook-form">
						<form id="editBook" action="edit_Book/${bookCode}" method="post" class="mt-5">
							<div class="form-group px-5">
								<label for="bookCode-input"><font color="#C0C0C0"
									style="margin-right: 0px">Book Code </font></label>
								<p
									style="color: white; display: inline-block; padding-left: 48px;">${bookCode}</p>
							...
							<div class="form-group px-5">
								...
								<p
									style="color: white; display: inline-block; padding-left: 48px;">${date}
								</p>
							</div>
							<br>
